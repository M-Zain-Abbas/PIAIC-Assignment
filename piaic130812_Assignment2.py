...
def function7():
    ...
    return np.zeros(x.size, dtype=np.int64)  #write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = arr.transpose() - brr.transpose()   # write your code here 
...
def function12():
    ...
    arr = np.array([1,2,3])
    #write your code here
    arr_2 = np.vstack((arr,arr))
    ans = np.vstack((arr_2, arr)).transpose().flatten()
